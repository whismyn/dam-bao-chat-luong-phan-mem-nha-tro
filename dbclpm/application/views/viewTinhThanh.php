...
<html>
    ...
    <body>
        ...
        foreach ($tinhThanhs as $tinhThanh) {
            $this->table->add_row($tinhThanh->MA_TINH, $tinhThanh->TEN_TINH, anchor('tinhThanh/xoa/' . $tinhThanh->MA_TINH, 'Xoa') . ' | ' . anchor('tinhThanh/capnhat/' . $tinhThanh->MA_TINH, 'Cap nhat'));
        }
