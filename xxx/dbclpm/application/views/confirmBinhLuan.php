                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            <img src="http://localhost/dbclpm/media/img/coment-icon.png" width="100" height="100">
                            Quản lý bình luận
                        </h1>
                            ...
                            <div class="col-lg-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h3 class="panel-title"><i class="fa fa-bar-chart-o fa-fw"></i> Danh sách bình luận của hệ thống
                                        </h3>
                                    </div>
                                    <div class="panel-body">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($binhLuans as $binhLuan) {
                                                echo "<tr>";
                                                echo "<th>".$binhLuan->MA_BL."</th>";
                                                echo "<th>".$binhLuan->MA_TK."</th>";
                                                echo "<th>".$binhLuan->NOI_DUNG."</th>";
                                                echo "<th>".$binhLuan->BAO_VP."</th>";
                                                echo "<th>".$binhLuan->TG_BL."</th>";
                                                echo "<th>&nbsp;&nbsp;&nbsp;";
                                                echo "<a class='glyphicon glyphicon-remove' href='";
                                                echo $url."index.php/binhLuan/xoa/".$binhLuan->MA_BL;
