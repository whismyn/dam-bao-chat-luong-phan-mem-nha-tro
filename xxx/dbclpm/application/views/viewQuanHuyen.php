                            ...
                            <div class="col-lg-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h3 class="panel-title"><i class="fa fa-bar-chart-o fa-fw"></i> Danh sách quận/huyện của hệ thống
                                        </h3>
                                    </div>
                                    <div class="panel-body">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($quanHuyens as $quanHuyen) {
                                                echo "<tr>";
                                                echo "<th>".$quanHuyen->MA_HUYEN."</th>";
                                                echo "<th>".$quanHuyen->TEN_HUYEN."</th>";
                                                echo "<th>".$quanHuyen->MA_TINH."</th>";
                                                echo "<th>&nbsp;&nbsp;&nbsp;";
                                                echo "<a class='glyphicon glyphicon-remove' href='";
                                                echo $url."index.php/quanHuyen/xoa/".$quanHuyen->MA_HUYEN;
                                                echo "' role='button' title='Xóa'></a>";
                                                echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
                                                echo "<a class='glyphicon glyphicon-pencil' href='";
                                                echo $url."index.php/quanHuyen/capnhat/".$quanHuyen->MA_HUYEN;
                                        ...
                                        <?php echo anchor("quanHuyen/them", "Thêm quận huyện") ?>
                                    </div>
                                </div>
                            </div>
