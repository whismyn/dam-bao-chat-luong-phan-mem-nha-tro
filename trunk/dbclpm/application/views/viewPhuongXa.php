                            ...
                            <div class="col-lg-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h3 class="panel-title"><i class="fa fa-bar-chart-o fa-fw"></i> Danh sách phường xã của hệ thống
                                        </h3>
                                    </div>
                                    <div class="panel-body">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($phuongXas as $phuongXa) {
                                                echo "<tr>";
                                                echo "<th>".$phuongXa->MA_XA."</th>";
                                                echo "<th>".$phuongXa->TEN_XA."</th>";
                                                echo "<th>".$phuongXa->MA_HUYEN."</th>";
                                                echo "<th>&nbsp;&nbsp;&nbsp;";
                                                echo "<a class='glyphicon glyphicon-remove' href='";
                                                echo $url."index.php/phuongXa/xoa/".$phuongXa->MA_XA;
                                                echo "' role='button' title='Xóa'></a>";
                                                echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
                                                echo "<a class='glyphicon glyphicon-pencil' href='";
                                                echo $url."index.php/phuongXa/capnhat/".$phuongXa->MA_XA;
