                            ...
                            <div class="col-lg-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h3 class="panel-title"><i class="fa fa-bar-chart-o fa-fw"></i> Thông tin nhà trọ từ hệ thống</h3>
                                    </div>
                                    <div class="panel-body">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($chuDes as $chuDe) {
                                                echo "<tr>";
                                                echo "<th>".$chuDe->MA_CHU_DE."</th>";
                                                echo "<th>".$chuDe->MA_CHU_DE_CHA."</th>";
                                                echo "<th>".$chuDe->TEN_TK."</th>";
                                                echo "<th>".$chuDe->TIEU_DE."</th>";
                                                echo "<th>".$chuDe->NOI_DUNG."</th>";
                                                echo "<th>".$chuDe->TG_TAO_CHU_DE."</th>";
                                                echo "<th>";
                                                echo "<a class='glyphicon glyphicon-remove' href='";
                                                echo $url."index.php/chuDe/xoa/".$chuDe->MA_CHU_DE;
