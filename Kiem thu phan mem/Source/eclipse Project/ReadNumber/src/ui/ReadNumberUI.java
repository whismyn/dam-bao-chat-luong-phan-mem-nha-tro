 ...
 * @author Admin
 */
public class ReadNumberUI extends javax.swing.JFrame {

    ReadNumber rn;

    /**
     * Creates new form ReadNumberUI
     */
    public ReadNumberUI() {
        initComponents();
        rn = new ReadNumber();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReadNumberUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ReadNumberUI().setVisible(true);
            }
        });
    }
